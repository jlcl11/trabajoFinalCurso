...
public class PantallaTitularesAllStar extends JPanel {
	/**
	 * Constructor de PantallaTitularesAllStar,que inicializa la distribución de la
	 ...
	 */
	public PantallaTitularesAllStar(final Ventana ventana) {
		...
		ArrayList<Jugador> todos = PartidoAllStar.getTitularesAllStar();
