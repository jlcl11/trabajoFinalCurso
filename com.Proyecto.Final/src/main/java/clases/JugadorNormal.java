...
public class JugadorNormal extends Jugador{
	...
	public JugadorNormal(String nombre, String apellido, byte dorsal, String apodo, Posicion posicion, float salario,
		...
		super(nombre, apellido, dorsal, apodo, posicion, salario, nominacionesAllStar, anillosDeCampeon, mVPs, defensorDelAño,
				rookieDelAño, mIP, mVPAllStar, fMVP, premioAnotador, pPG, aPG, rBG, sPG, bPG, mPG, ataque, defensa, intangibles,
				clutch);
