...
public class Jugador extends ObjetoConNombre {
	...
	public String toString() {
		...
		if (salario > 0 && apodo == null && rookieDelAño == true && MIP == false) {
			return getNombre() + " " + apellido + "nº" + dorsal + ", juega de " + posicion
					+ ", cobra " + salario + ",millones de dólares,ha sido nominado " + nominacionesAllStar
					+ " veces para el all Star, ha ganado =" + anillosDeCampeon
					+ "anillos de campeón, ha ganado el MVP " + MVPs + "veces,ha ganado el defensor del año "
					+ defensorDelAño
					+ "veces,fue ganador del rookie del año,ha sido MVP del AllStar" + MVPAllStar
					...
					+ " en finalización,una " + tiro + " en tiro,una " + organizacion + " en organización y una "
					+ defensas + " en defensa"+"\n";
		}
		if (salario > 0 && apodo != null && MIP == true && rookieDelAño == false) {
			return getNombre() + " '" + getApodo() + "' " + apellido + "nº" + dorsal + ", juega de " + posicion
					+ ", cobra " + salario + ",millones de dólares,ha sido nominado " + nominacionesAllStar
					+ " veces para el all Star, ha ganado =" + anillosDeCampeon
					+ "anillos de campeón, ha ganado el MVP " + MVPs + "veces,ha ganado el defensor del año "
					+ defensorDelAño
		...
		if (salario > 0 && apodo != null && rookieDelAño == true && MIP == true) {
			return getNombre() + " '" + getApodo() + "' " + apellido + "nº" + dorsal + ", juega de " + posicion
					+ ", cobra " + salario + ",millones de dólares,ha sido nominado " + nominacionesAllStar
					+ " veces para el all Star, ha ganado =" + anillosDeCampeon
					+ "anillos de campeón, ha ganado el MVP " + MVPs + "veces,ha ganado el defensor del año "
					+ defensorDelAño
					+ "veces,fue ganador del rookie del año,fue ganador del MIP,ha sido MVP del AllStar" + MVPAllStar
					+ " veces,ha ganado el FMVP " + FMVP + " veces,ha ganado el premio anotador " + premioAnotador
					+ "veces ,anota" + PPG + " puntos por partido, reparte " + APG + " asistencias por partido,recoge "
					+ RBG + " rebotes por partido,roba " + SPG + " balones por partido,tapona " + BPG
					+ " tiros por partido,juega " + MPG + " minutos cada partido,tiene una nota" + finalizacion
